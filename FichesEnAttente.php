...
switch($_SESSION['user']['nomRole']){
                            case "Admin":
                                $requeteUserDirection = "SELECT idFiche, DATE_FORMAT(dateFiche,'%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif,'%d-%m-%Y') as dateModif, commentaire, etat, sigleDirection
                                                            FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' ORDER BY idFiche DESC";
                                $requeteCountUD = "SELECT count(*) as countF FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente'";
                            ...
                            case "Chef de service":
                                $requeteUserDirection = "SELECT idFiche, DATE_FORMAT(dateFiche,'%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif,'%d-%m-%Y') as dateModif, commentaire, etat, sigleDirection
                                                            FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and d.idDirection = $userDirection and etat = 'en attente' and v1 = false ORDER BY idFiche DESC";
                                $requeteCountUD = "SELECT count(*) as countF FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and d.idDirection = $userDirection and etat = 'en attente' and v1 = false";
                            ...
                            case "DGAO":
                                $requeteUserDirection = "SELECT idFiche, DATE_FORMAT(dateFiche,'%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif,'%d-%m-%Y') as dateModif, commentaire, sigleDirection,dga, etat
                                                            FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = false and v1 = true and dga = 'Chargé des opérations' ORDER BY idFiche DESC";
                                $requeteCountUD = "SELECT count(*) as countF FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = false and v1 = true and f.dga = 'Chargé des opérations'";
                            ...
                            case "DGAT":
                                $requeteUserDirection = "SELECT idFiche, DATE_FORMAT(dateFiche,'%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif,'%d-%m-%Y') as dateModif, commentaire, sigleDirection,dga, etat
                                                            FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = false and v1 = true and f.dga = 'Technique' ORDER BY idFiche DESC";
                                $requeteCountUD = "SELECT count(*) as countF FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = false and v1 = true and f.dga = 'Technique'";
                            ...
                            case "DG":
                                $requeteUserDirection = "SELECT idFiche, DATE_FORMAT(dateFiche,'%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif,'%d-%m-%Y') as dateModif, commentaire, sigleDirection,dga, etat
                                                            FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = true and v1 = true ORDER BY idFiche DESC";
                                $requeteCountUD = "SELECT count(*) as countF FROM Fiche as f, Direction as d where d.idDirection = f.idDirection and etat = 'en attente' and v2 = true and v1 = true" ;
...
?>
    ...
    <div class="allonger parent container">
            <div class="parent panel panel-success margetop">
                <div class= "margetop panel-heading">Filtrer par Direction et/ou Status...</div>
        ...
        <br>
        <h2 style = "text-align: center;"><label><u>Liste des fiches de besoins - <?php echo $nbrFicheUD; ?> Fiche(s)</u></label></h2>
        <br><br>
<?php 
    $tableCounter = 0;
    while($fiche = $resultatUserDirection->fetch()) {
        if($tableCounter % 4 == 0) {
        ?>
            ...
            <table class = "margeleft">
                <div border = "1">
                    ...
                    <tr>
                        ...
                        <td >
                            <a  href = "voirFicheEnAttente.php?idFiche=<?php echo $fiche['idFiche'] ?>">
                                Voir les details
