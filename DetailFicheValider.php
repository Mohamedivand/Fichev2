...
<html>
    ...
    $requetef = "SELECT idFiche, DATE_FORMAT(dateFiche, '%d-%m-%Y') as dateFiche, DATE_FORMAT(dateModif, '%d-%m-%Y') as dateModif, dga, destination, commentaire, nomDirection, remarque, v1, v2, v3, dm1, dm2, dm3, r1, r2, r3, sign1, sign2, sign3, demandeModif, auteurRejet, sigleDirection, etat from Fiche as f, Direction as d where f.idDirection = d.idDirection and idFiche = '$idFiche'";
    $requetep = "SELECT nomProduit, quantite, nomCategorie from Produit as p, Categorie as c where p.idCategorie = c.idCategorie and idFiche = '$idFiche' order by idProduit";
...
?>
        ...
        <div class = "marginright right" id="print-button">
                    ...
                    <?php if($fiche['etat'] !== "validée" && $fiche['etat'] !== "rejetée"){ ?>
                      ...
                      <a href ="Modifier.php?idFiche=<?php echo $idFiche?>" id="print-button">            
                          <button id="print-button">
