    ...
    <img src='../Images/LogoPMU.png' width="380" height="176" style="float: left;"/>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary" style = "margin-top: 150px;">
                    <div class= "panel-heading">Ajout d'une nouvelle direction:</div>
                    <div class= "panel-body">
                       <form method="post" action="InsertDirection.php" class="form">
                        
                       <div class="form-group">
                            <label for="nomDirection">Nom de la direction : </label>
                            <input type="text" name="nomDirection"
                                   placeholder="Exemple: Direction informatique"
                                   class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="nom">Sigle ou abréviation: </label>
                            <input type="text" name="sigleDirection"
                                   placeholder="Exemple: DI"
