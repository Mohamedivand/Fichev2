...
?>
<?php
                                if($_SESSION['user']['sigleDirection']==="DI" || $_SESSION['user']['sigleDirection']==="DPMG" || $_SESSION['user']['nomDirection']==="Direction générale" || $_SESSION['user']['nomRole']==="Admin"){
                            ?>
                            ...
                            echo $fiche['dateFiche'];} ?></td>
                                ...
                                <tr>
                                    ...
                                    <td <?php if($fiche['etat'] == "validée"){?> style = "color: #3CB371; font-weight: bold;" <?php }
                                        ...
                                        elseif($fiche['etat'] == "Abandonnée"){ ?> style = "color: red; font-weight: bold;" <?php }
